...
func BlockOneCoinbasePaysTokens(tx *cdrutil.Tx, params *chaincfg.Params) error {
	...
	for i, txout := range tx.MsgTx().TxOut {
		...
		addrLedger, err := cdrutil.DecodeAddress(ledger[i].Address)
		if err != nil {
			return err
		}
...
func CoinbasePaysTax(subsidyCache *SubsidyCache, tx *cdrutil.Tx, height int64, voters uint16, params *chaincfg.Params) error {
...
func CalculateAddedSubsidy(block, parent *cdrutil.Block) int64 {
	var subsidy int64
