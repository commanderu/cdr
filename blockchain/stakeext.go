...
//
// This function is safe for concurrent access.
func (b *BlockChain) TicketsWithAddress(address cdrutil.Address) ([]chainhash.Hash, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
...
func (b *BlockChain) TicketPoolValue() (cdrutil.Amount, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
