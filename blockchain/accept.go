...
// impossible.
func checkCoinbaseUniqueHeight(blockHeight int64, block *cdrutil.Block) error {
...
func IsFinalizedTransaction(tx *cdrutil.Tx, blockHeight int64, blockTime time.Time) bool {
...
func (b *BlockChain) maybeAcceptBlock(block *cdrutil.Block, flags BehaviorFlags) (bool, error) {
