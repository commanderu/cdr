...
// CalcWork calculates a work value from difficulty bits.  commanderu increases
...
// weighted averages.
//
// NOTE: This is the original stake difficulty algorithm that was used at commanderu
// launch.
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) calcNextRequiredStakeDifficultyV1(curNode *blockNode) (int64, error) {
	...
	// commanderu parameters, but might do weird things if you use custom
	// parameters.
	if curNode == nil ||
