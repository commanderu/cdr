...
func TestSStx(t *testing.T) {
	var sstx = cdrutil.NewTx(sstxMsgTx)
	...
	sstx = cdrutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = cdrutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = cdrutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = cdrutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = cdrutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = cdrutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = cdrutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = cdrutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = cdrutil.NewTx(&tx)
	...
	var sstxWrongPrefix = cdrutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = cdrutil.NewTx(ssgenMsgTx)
	...
	ssgen = cdrutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = cdrutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = cdrutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = cdrutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = cdrutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = cdrutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = cdrutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = cdrutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = cdrutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = cdrutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = cdrutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = cdrutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = cdrutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = cdrutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = cdrutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = cdrutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = cdrutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = cdrutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = cdrutil.NewTx(&tx)
...
func TestVerifyRealTxs(t *testing.T) {
	...
	ssrtxTx := cdrutil.NewTx(ssrtxMtx)
