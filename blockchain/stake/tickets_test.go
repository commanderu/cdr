...
import (
	...
	"github.com/commanderu/cdrd/blockchain/stake/internal/tickettreap"
...
func ticketsInBlock(bl *cdrutil.Block) []chainhash.Hash {
...
func ticketsSpentInBlock(bl *cdrutil.Block) []chainhash.Hash {
...
func revokedTicketsInBlock(bl *cdrutil.Block) []chainhash.Hash {
...
func TestTicketDBLongChain(t *testing.T) {
	...
	testBlockchain := make(map[int64]*cdrutil.Block, len(testBlockchainBytes))
	for k, v := range testBlockchainBytes {
		bl, err := cdrutil.NewBlockFromBytes(v)
		if err != nil {
