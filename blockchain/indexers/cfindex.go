...
func storeFilter(dbTx database.Tx, block *cdrutil.Block, f *gcs.Filter, filterType wire.FilterType) error {
...
func (idx *CFIndex) ConnectBlock(dbTx database.Tx, block, parent *cdrutil.Block, view *blockchain.UtxoViewpoint) error {
...
func (idx *CFIndex) DisconnectBlock(dbTx database.Tx, block, parent *cdrutil.Block, view *blockchain.UtxoViewpoint) error {
