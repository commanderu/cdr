...
import (
	...
	"github.com/commanderu/cdrd/blockchain/internal/dbnamespace"
...
func serializeSizeForMinimalOutputs(tx *cdrutil.Tx) int {
...
func putTxToMinimalOutputs(target []byte, tx *cdrutil.Tx) int {
...
// already there.
func dbMaybeStoreBlock(dbTx database.Tx, block *cdrutil.Block) error {
...
// The amount is never encoded into spent transaction outputs in commanderu
...
func decodeSpentTxOut(serialized []byte, stxo *spentTxOut, amount int64, height uint32, index uint32) (int, error) {
	...
	// since in commanderu we only need pkScript at most due to fraud proofs
...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *cdrutil.Block, parent *cdrutil.Block) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := cdrutil.NewBlock(b.chainParams.GenesisBlock)
...
// from the index, and return a cdrutil.Block with the height set.
func dbFetchBlockByHash(dbTx database.Tx, hash *chainhash.Hash) (*cdrutil.Block, error) {
...
// raw block for the provided height, deserialize it, and return a cdrutil.Block
// with the height set.
func dbFetchBlockByHeight(dbTx database.Tx, height int64) (*cdrutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(blockHeight int64) (*cdrutil.Block, error) {
	var block *cdrutil.Block
	err := b.db.View(func(dbTx database.Tx) error {
		var err error
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*cdrutil.Block, error) {
	b.chainLock.RLock()
