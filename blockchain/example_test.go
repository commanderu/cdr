...
// overview documentation describes, this includes all of the commanderu consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// exists.
	genesisBlock := cdrutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
...
func ExampleCompactToBig() {
	// Convert the bits from block 300000 in the main commanderu block chain.
