...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/commanderu/cdrd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/commanderu/cdrd/blockchain/fullblocktests
```
