...
func (view *UtxoViewpoint) AddTxOuts(tx *cdrutil.Tx, blockHeight int64, blockIndex uint32) {
	msgTx := tx.MsgTx()
...
func (view *UtxoViewpoint) connectTransaction(tx *cdrutil.Tx, blockHeight int64, blockIndex uint32, stxos *[]spentTxOut) error {
	msgTx := tx.MsgTx()
...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *cdrutil.Block, parent *cdrutil.Block, stxos *[]spentTxOut) error {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint, block *cdrutil.Block, parent *cdrutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*cdrutil.Tx, height int64, stxosPtr *[]spentTxOut) (int, error) {
	if stxosPtr == nil {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block, parent *cdrutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *cdrutil.Tx, treeValid bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
