...
func ValidateTransactionScripts(tx *cdrutil.Tx, utxoView *UtxoViewpoint, flags txscript.ScriptFlags, sigCache *txscript.SigCache) error {
...
func checkBlockScripts(block *cdrutil.Block, utxoView *UtxoViewpoint, txTree bool,
