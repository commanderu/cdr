...
func TestWalletSvrWsCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("createencryptedwallet", "pass")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewCreateEncryptedWalletCmd("pass")
			},
			marshalled:   `{"jsonrpc":"1.0","method":"createencryptedwallet","params":["pass"],"id":1}`,
			unmarshalled: &cdrjson.CreateEncryptedWalletCmd{Passphrase: "pass"},
		},
		{
			name: "exportwatchingwallet",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("exportwatchingwallet")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewExportWatchingWalletCmd(nil, nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"exportwatchingwallet","params":[],"id":1}`,
			unmarshalled: &cdrjson.ExportWatchingWalletCmd{
				Account:  nil,
				Download: cdrjson.Bool(false),
			},
		},
		{
			name: "exportwatchingwallet optional1",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("exportwatchingwallet", "acct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewExportWatchingWalletCmd(cdrjson.String("acct"), nil)
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("exportwatchingwallet", "acct", true)
			},
			staticCmd: func() interface{} {
				return cdrjson.NewExportWatchingWalletCmd(cdrjson.String("acct"),
					cdrjson.Bool(true))
			},
			marshalled: `{"jsonrpc":"1.0","method":"exportwatchingwallet","params":["acct",true],"id":1}`,
			unmarshalled: &cdrjson.ExportWatchingWalletCmd{
				Account:  cdrjson.String("acct"),
				Download: cdrjson.Bool(true),
			},
		},
		{
			name: "getunconfirmedbalance",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("getunconfirmedbalance")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewGetUnconfirmedBalanceCmd(nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"getunconfirmedbalance","params":[],"id":1}`,
			unmarshalled: &cdrjson.GetUnconfirmedBalanceCmd{
				Account: nil,
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("getunconfirmedbalance", "acct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewGetUnconfirmedBalanceCmd(cdrjson.String("acct"))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("listaddresstransactions", `["1Address"]`)
			},
			staticCmd: func() interface{} {
				return cdrjson.NewListAddressTransactionsCmd([]string{"1Address"}, nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"listaddresstransactions","params":[["1Address"]],"id":1}`,
			unmarshalled: &cdrjson.ListAddressTransactionsCmd{
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("listaddresstransactions", `["1Address"]`, "acct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewListAddressTransactionsCmd([]string{"1Address"},
					cdrjson.String("acct"))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("listalltransactions")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewListAllTransactionsCmd(nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"listalltransactions","params":[],"id":1}`,
			unmarshalled: &cdrjson.ListAllTransactionsCmd{
				Account: nil,
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("listalltransactions", "acct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewListAllTransactionsCmd(cdrjson.String("acct"))
			},
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("recoveraddresses", "acct", 10)
			},
			staticCmd: func() interface{} {
				return cdrjson.NewRecoverAddressesCmd("acct", 10)
			},
			marshalled: `{"jsonrpc":"1.0","method":"recoveraddresses","params":["acct",10],"id":1}`,
			unmarshalled: &cdrjson.RecoverAddressesCmd{
				Account: "acct",
				N:       10,
			},
		},
		{
			name: "walletislocked",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("walletislocked")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewWalletIsLockedCmd()
			},
			marshalled:   `{"jsonrpc":"1.0","method":"walletislocked","params":[],"id":1}`,
			unmarshalled: &cdrjson.WalletIsLockedCmd{},
		},
	}
