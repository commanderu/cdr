...
func TestBtcWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("createnewaccount", "acct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewCreateNewAccountCmd("acct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"createnewaccount","params":["acct"],"id":1}`,
			unmarshalled: &cdrjson.CreateNewAccountCmd{
				Account: "acct",
			},
		},
		{
			name: "importaddress",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("importaddress", "1Address")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewImportAddressCmd("1Address", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importaddress","params":["1Address"],"id":1}`,
			unmarshalled: &cdrjson.ImportAddressCmd{
				Address: "1Address",
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("importaddress", "1Address", false)
			},
			staticCmd: func() interface{} {
				return cdrjson.NewImportAddressCmd("1Address", cdrjson.Bool(false))
			},
		...
		},
		{
			name: "importpubkey",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("importpubkey", "031234")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewImportPubKeyCmd("031234", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importpubkey","params":["031234"],"id":1}`,
			unmarshalled: &cdrjson.ImportPubKeyCmd{
				PubKey: "031234",
				Rescan: cdrjson.Bool(true),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("importpubkey", "031234", false)
			},
			staticCmd: func() interface{} {
				return cdrjson.NewImportPubKeyCmd("031234", cdrjson.Bool(false))
			},
		...
		},
		{
			name: "renameaccount",
			newCmd: func() (interface{}, error) {
				return cdrjson.NewCmd("renameaccount", "oldacct", "newacct")
			},
			staticCmd: func() interface{} {
				return cdrjson.NewRenameAccountCmd("oldacct", "newacct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"renameaccount","params":["oldacct","newacct"],"id":1}`,
			unmarshalled: &cdrjson.RenameAccountCmd{
				OldAccount: "oldacct",
				NewAccount: "newacct",
			},
		},
