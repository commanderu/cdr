...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return cdrjson.NewCmd("blockconnected", "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
				return cdrjson.NewBlockConnectedNtfn("header", []string{"tx0", "tx1"})
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockconnected","params":["header",["tx0","tx1"]],"id":null}`,
			unmarshalled: &cdrjson.BlockConnectedNtfn{
				Header:        "header",
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cdrjson.NewCmd("blockdisconnected", "header")
			},
			staticNtfn: func() interface{} {
				return cdrjson.NewBlockDisconnectedNtfn("header")
			},
			marshalled: `{"jsonrpc":"1.0","method":"blockdisconnected","params":["header"],"id":null}`,
			unmarshalled: &cdrjson.BlockDisconnectedNtfn{
				Header: "header",
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cdrjson.NewCmd("relevanttxaccepted", "001122")
			},
			staticNtfn: func() interface{} {
				return cdrjson.NewRelevantTxAcceptedNtfn("001122")
			},
			marshalled: `{"jsonrpc":"1.0","method":"relevanttxaccepted","params":["001122"],"id":null}`,
			unmarshalled: &cdrjson.RelevantTxAcceptedNtfn{
				Transaction: "001122",
			},
		},
		{
			name: "txaccepted",
			newNtfn: func() (interface{}, error) {
				return cdrjson.NewCmd("txaccepted", "123", 1.5)
			},
			staticNtfn: func() interface{} {
				return cdrjson.NewTxAcceptedNtfn("123", 1.5)
			},
			marshalled: `{"jsonrpc":"1.0","method":"txaccepted","params":["123",1.5],"id":null}`,
			unmarshalled: &cdrjson.TxAcceptedNtfn{
				TxID:   "123",
				Amount: 1.5,
			},
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return cdrjson.NewCmd("txacceptedverbose", `{"hex":"001122","txid":"123","version":1,"locktime":4294967295,"vin":null,"vout":null,"confirmations":0}`)
			},
			staticNtfn: func() interface{} {
				txResult := cdrjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
				...
				return cdrjson.NewTxAcceptedVerboseNtfn(txResult)
			},
			...
			unmarshalled: &cdrjson.TxAcceptedVerboseNtfn{
				RawTx: cdrjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
