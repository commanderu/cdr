...
const (
	...
	BtcdConnectedNtfnMethod = "cdrdconnected"
...
// BtcdConnectedNtfn defines the cdrddconnected JSON-RPC notification.
type BtcdConnectedNtfn struct {
	Connected bool
}

// NewBtcdConnectedNtfn returns a new instance which can be used to issue a
// cdrddconnected JSON-RPC notification.
