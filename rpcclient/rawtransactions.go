...
func (r FutureGetRawTransactionResult) Receive() (*cdrutil.Tx, error) {
	...
	return cdrutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := cdrjson.NewGetRawTransactionCmd(hash, cdrjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*cdrutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*cdrjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult cdrjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := cdrjson.NewGetRawTransactionCmd(hash, cdrjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*cdrjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*cdrjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := cdrjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*cdrjson.TxRawResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []cdrjson.TransactionInput,
	amounts map[cdrutil.Address]cdrutil.Amount, lockTime *int64, expiry *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToCoin()
	}
	cmd := cdrjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime, expiry)
	return c.sendCmd(cmd)
}

// CreateRawTransaction returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawTransaction(inputs []cdrjson.TransactionInput,
	amounts map[cdrutil.Address]cdrutil.Amount, lockTime *int64, expiry *int64) (*wire.MsgTx, error) {
...
type SStxCommitOut struct {
	...
	CommitAmt  cdrutil.Amount
	ChangeAddr cdrutil.Address
	ChangeAmt  cdrutil.Amount
}
...
func (c *Client) CreateRawSStxAsync(inputs []cdrjson.SStxInput,
	amount map[cdrutil.Address]cdrutil.Amount,
	...
	cmd := cdrjson.NewCreateRawSStxCmd(inputs,
		convertedAmt,
		convertedCouts)
...
// and sending to the provided addresses.
func (c *Client) CreateRawSStx(inputs []cdrjson.SStxInput,
	amount map[cdrutil.Address]cdrutil.Amount,
...
func (c *Client) CreateRawSSGenTxAsync(inputs []cdrjson.TransactionInput,
	votebits uint16) FutureCreateRawSSGenTxResult {

	cmd := cdrjson.NewCreateRawSSGenTxCmd(inputs, votebits)
	return c.sendCmd(cmd)
}

// CreateRawSSGenTx returns a new transaction spending the provided inputs
// and sending to the provided addresses.
func (c *Client) CreateRawSSGenTx(inputs []cdrjson.TransactionInput,
...
func (c *Client) CreateRawSSRtxAsync(inputs []cdrjson.TransactionInput, fee cdrutil.Amount) FutureCreateRawSSRtxResult {
	feeF64 := fee.ToCoin()
	cmd := cdrjson.NewCreateRawSSRtxCmd(inputs, &feeF64)
	return c.sendCmd(cmd)
}

// CreateRawSSRtx returns a new SSR transactionm (revoking an sstx).
func (c *Client) CreateRawSSRtx(inputs []cdrjson.TransactionInput, fee cdrutil.Amount) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	cmd := cdrjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	return c.sendCmd(cmd)
}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult cdrjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := cdrjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []cdrjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := cdrjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []cdrjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := cdrjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []cdrjson.RawTxInput, privKeysWIF []string,
	...
	cmd := cdrjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		cdrjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawSSGenTxAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := cdrjson.NewSignRawTransactionCmd(txHex, &[]cdrjson.RawTxInput{},
		nil, cdrjson.String("ssgen"))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address cdrutil.Address, skip,
	count int, reverse bool,
	filterAddrs []string) FutureSearchRawTransactionsResult {

	addr := address.EncodeAddress()
	verbose := cdrjson.Int(0)
	prevOut := cdrjson.Int(0)
	cmd := cdrjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address cdrutil.Address, skip, count int,
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*cdrjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*cdrjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address cdrutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address cdrutil.Address, skip,
	count int, includePrevOut bool, reverse bool,
	filterAddrs []string) ([]*cdrjson.SearchRawTransactionsResult, error) {
