...
func (c *Client) GenerateAsync(numBlocks uint32) FutureGenerateResult {
	cmd := cdrjson.NewGenerateCmd(numBlocks)
...
func (c *Client) SetGenerateAsync(enable bool, numCPUs int) FutureSetGenerateResult {
	cmd := cdrjson.NewSetGenerateCmd(enable, &numCPUs)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHashesPerSecAsync() FutureGetHashesPerSecResult {
	cmd := cdrjson.NewGetHashesPerSecCmd()
	return c.sendCmd(cmd)
}
...
// information.
func (r FutureGetMiningInfoResult) Receive() (*cdrjson.GetMiningInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoResult cdrjson.GetMiningInfoResult
...
func (c *Client) GetMiningInfoAsync() FutureGetMiningInfoResult {
	cmd := cdrjson.NewGetMiningInfoCmd()
	return c.sendCmd(cmd)
}

// GetMiningInfo returns mining information.
func (c *Client) GetMiningInfo() (*cdrjson.GetMiningInfoResult, error) {
...
func (c *Client) GetNetworkHashPSAsync() FutureGetNetworkHashPS {
	cmd := cdrjson.NewGetNetworkHashPSCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS2Async(blocks int) FutureGetNetworkHashPS {
	cmd := cdrjson.NewGetNetworkHashPSCmd(&blocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNetworkHashPS3Async(blocks, height int) FutureGetNetworkHashPS {
	cmd := cdrjson.NewGetNetworkHashPSCmd(&blocks, &height)
	return c.sendCmd(cmd)
}
...
// data to work on.
func (r FutureGetWork) Receive() (*cdrjson.GetWorkResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result cdrjson.GetWorkResult
	err = json.Unmarshal(res, &result)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetWork() (*cdrjson.GetWorkResult, error) {
...
func (c *Client) GetWorkSubmitAsync(data string) FutureGetWorkSubmit {
	cmd := cdrjson.NewGetWorkCmd(&data)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockTemplate) Receive() (*cdrjson.GetBlockTemplateResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result.
	var gbt cdrjson.GetBlockTemplateResult
...
func (c *Client) GetBlockTemplateAsync(req *cdrjson.TemplateRequest) FutureGetBlockTemplate {
	cmd := cdrjson.NewGetBlockTemplateCmd(req)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockTemplate(req *cdrjson.TemplateRequest) (*cdrjson.GetBlockTemplateResult, error) {
...
func (c *Client) SubmitBlockAsync(block *cdrutil.Block, options *cdrjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
	...
	cmd := cdrjson.NewSubmitBlockCmd(blockHex, options)
	return c.sendCmd(cmd)
}

// SubmitBlock attempts to submit a new block into the commanderu network.
func (c *Client) SubmitBlock(block *cdrutil.Block, options *cdrjson.SubmitBlockOptions) error {
