...
import (
	...
	"github.com/commanderu/cdrd/gcs"
	"github.com/commanderu/cdrd/gcs/blockcf"
...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := cdrjson.NewGetBestBlockHashCmd()
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := cdrjson.NewGetBlockCmd(hash, cdrjson.Bool(false), nil)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockVerboseResult) Receive() (*cdrjson.GetBlockVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var blockResult cdrjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash, verboseTx bool) FutureGetBlockVerboseResult {
	...
	cmd := cdrjson.NewGetBlockCmd(hash, cdrjson.Bool(true), &verboseTx)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash, verboseTx bool) (*cdrjson.GetBlockVerboseResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := cdrjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := cdrjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := cdrjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(hash *chainhash.Hash) FutureGetBlockHeaderResult {
	cmd := cdrjson.NewGetBlockHeaderCmd(hash.String(), cdrjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*cdrjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var bh cdrjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(hash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	cmd := cdrjson.NewGetBlockHeaderCmd(hash.String(), cdrjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(hash *chainhash.Hash) (*cdrjson.GetBlockHeaderVerboseResult, error) {
...
func (r FutureGetBlockSubsidyResult) Receive() (*cdrjson.GetBlockSubsidyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal the result
	var bs cdrjson.GetBlockSubsidyResult
...
func (c *Client) GetBlockSubsidyAsync(height int64, voters uint16) FutureGetBlockSubsidyResult {
	cmd := cdrjson.NewGetBlockSubsidyCmd(height, voters)
	return c.sendCmd(cmd)
}

// GetBlockSubsidy returns a data structure of the block subsidy
// from the server given its height and number of voters.
func (c *Client) GetBlockSubsidy(height int64, voters uint16) (*cdrjson.GetBlockSubsidyResult, error) {
...
// Receive waits for the response promised by the future and returns the
// current coin supply
func (r FutureGetCoinSupplyResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetCoinSupplyAsync() FutureGetCoinSupplyResult {
	cmd := cdrjson.NewGetCoinSupplyCmd()
	return c.sendCmd(cmd)
}

// GetCoinSupply returns the current coin supply
func (c *Client) GetCoinSupply() (cdrutil.Amount, error) {
...
func (c *Client) GetRawMempoolAsync(txType cdrjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolResult {
	cmd := cdrjson.NewGetRawMempoolCmd(cdrjson.Bool(false),
		cdrjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempool(txType cdrjson.GetRawMempoolTxTypeCmd) ([]*chainhash.Hash, error) {
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]cdrjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]cdrjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync(txType cdrjson.GetRawMempoolTxTypeCmd) FutureGetRawMempoolVerboseResult {
	cmd := cdrjson.NewGetRawMempoolCmd(cdrjson.Bool(true),
		cdrjson.String(string(txType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose(txType cdrjson.GetRawMempoolTxTypeCmd) (map[string]cdrjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := cdrjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int64) FutureVerifyChainResult {
	cmd := cdrjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int64) FutureVerifyChainResult {
	cmd := cdrjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*cdrjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *cdrjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := cdrjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*cdrjson.GetTxOutResult, error) {
...
func (r FutureRescanResult) Receive() (*cdrjson.RescanResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanResult *cdrjson.RescanResult
...
func (c *Client) RescanAsync(blockHashes []chainhash.Hash) FutureRescanResult {
	...
	cmd := cdrjson.NewRescanCmd(hex.EncodeToString(concatenatedBlockHashes))
	return c.sendCmd(cmd)
}
...
func (c *Client) Rescan(blockHashes []chainhash.Hash) (*cdrjson.RescanResult, error) {
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterResult {
	...
	cmd := cdrjson.NewGetCFilterCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash, filterType wire.FilterType) FutureGetCFilterHeaderResult {
	...
	cmd := cdrjson.NewGetCFilterHeaderCmd(blockHash.String(), ft)
	return c.sendCmd(cmd)
}
