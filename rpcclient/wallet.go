...
import (
	...
	"github.com/commanderu/cdrd/chaincfg/chainhash"
	"github.com/commanderu/cdrd/cdrjson"
	"github.com/commanderu/cdrd/cdrutil"
	"github.com/commanderu/cdrd/wire"
)
...
func (r FutureGetTransactionResult) Receive() (*cdrjson.GetTransactionResult, error) {
	...
	var getTx cdrjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := cdrjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*cdrjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]cdrjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []cdrjson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := cdrjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]cdrjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := cdrjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]cdrjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := cdrjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]cdrjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]cdrjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []cdrjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := cdrjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := cdrjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := cdrjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []cdrutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := cdrjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]cdrjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]cdrjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]cdrjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []cdrutil.Address) ([]cdrjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*cdrjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult cdrjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = cdrjson.String(blockHash.String())
	}

	cmd := cdrjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*cdrjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := cdrjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*cdrjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]cdrjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = cdrjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
			Tree: op.Tree,
		}
	}
	cmd := cdrjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []cdrjson.TransactionInput
	...
	for i, input := range inputs {
		...
		ops[i] = wire.NewOutPoint(sha, input.Vout, input.Tree) // commanderu TODO
	}
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := cdrjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address cdrutil.Address, amount cdrutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewSendToAddressCmd(addr, amount.ToCoin(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address cdrutil.Address, amount cdrutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address cdrutil.Address,
	amount cdrutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := cdrjson.NewSendToAddressCmd(addr, amount.ToCoin(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address cdrutil.Address, amount cdrutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress cdrutil.Address, amount cdrutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := cdrjson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress cdrutil.Address, amount cdrutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress cdrutil.Address, amount cdrutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := cdrjson.NewSendFromCmd(fromAccount, addr, amount.ToCoin(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress cdrutil.Address, amount cdrutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress cdrutil.Address, amount cdrutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress cdrutil.Address,
	amount cdrutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[cdrutil.Address]cdrutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToCoin()
	}
	cmd := cdrjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[cdrutil.Address]cdrutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[cdrutil.Address]cdrutil.Amount,
	...
	cmd := cdrjson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[cdrutil.Address]cdrutil.Amount, minConfirms int,
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit cdrutil.Amount, minConf *int, ticketAddress cdrutil.Address,
	numTickets *int, poolAddress cdrutil.Address, poolFees *cdrutil.Amount,
	expiry *int, noSplitTransaction *bool, ticketFee *cdrutil.Amount) FuturePurchaseTicketResult {
	...
	cmd := cdrjson.NewPurchaseTicketCmd(fromAccount, spendLimit.ToCoin(),
...
func (c *Client) PurchaseTicket(fromAccount string,
	spendLimit cdrutil.Amount, minConf *int, ticketAddress cdrutil.Address,
	numTickets *int, poolAddress cdrutil.Address, poolFees *cdrutil.Amount,
	expiry *int, noSplitTransaction *bool, ticketFee *cdrutil.Amount) ([]*chainhash.Hash, error) {
...
func (c *Client) SendToSStxAsync(fromAccount string,
	...
	convertedCouts := make([]cdrjson.SStxCommitOut, len(couts))
	...
	cmd := cdrjson.NewSendToSStxCmd(fromAccount, convertedAmounts,
...
func (c *Client) SendToSSGenAsync(fromAccount string,
	...
	cmd := cdrjson.NewSendToSSGenCmd(fromAccount, ticketHashString,
...
func (c *Client) SendToSSRtxAsync(fromAccount string,
	...
	cmd := cdrjson.NewSendToSSRtxCmd(fromAccount, ticketHashString, nil)
...
func (c *Client) SendToSSRtxCommentAsync(fromAccount string,
	...
	cmd := cdrjson.NewSendToSSRtxCmd(fromAccount, ticketHashString, &comment)
...
func (r FutureAddMultisigAddressResult) Receive() (cdrutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return cdrutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []cdrutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := cdrjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []cdrutil.Address, account string) (cdrutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*cdrjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes cdrjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []cdrutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := cdrjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []cdrutil.Address) (*cdrjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := cdrjson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (cdrutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := cdrjson.NewGetNewAddressCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetNewAddressGapPolicyAsync(account string, gapPolicy GapPolicy) FutureGetNewAddressResult {
	cmd := cdrjson.NewGetNewAddressCmd(&account, (*string)(&gapPolicy))
	return c.sendCmd(cmd)
}

// GetNewAddress returns a new address.
func (c *Client) GetNewAddress(account string) (cdrutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (cdrutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (cdrutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := cdrjson.NewGetRawChangeAddressCmd(&account)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawChangeAddress(account string) (cdrutil.Address, error) {
...
// commanderu address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (cdrutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := cdrjson.NewGetAccountAddressCmd(account)
	return c.sendCmd(cmd)
}

// GetAccountAddress returns the current commanderu address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (cdrutil.Address, error) {
...
func (c *Client) GetAccountAsync(address cdrutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address cdrutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]cdrutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]cdrutil.Address, 0, len(addrStrings))
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := cdrjson.NewGetAddressesByAccountCmd(account)
	return c.sendCmd(cmd)
}

// GetAddressesByAccount returns the list of addresses associated with the
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]cdrutil.Address, error) {
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := cdrjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
// about the given commanderu address.
func (r FutureValidateAddressResult) Receive() (*cdrjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult cdrjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address cdrutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given commanderu address.
func (c *Client) ValidateAddress(address cdrutil.Address) (*cdrjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := cdrjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := cdrjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]cdrutil.Amount)
	for k, v := range accounts {
		amount, err := cdrutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := cdrjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]cdrutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := cdrjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]cdrutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (*cdrjson.GetBalanceResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var balance cdrjson.GetBalanceResult
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := cdrjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (*cdrjson.GetBalanceResult, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := cdrjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (*cdrjson.GetBalanceResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := cdrutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := cdrjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (cdrutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := cdrjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (cdrutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := cdrjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (cdrutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address cdrutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address cdrutil.Address) (cdrutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address cdrutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address cdrutil.Address, minConfirms int) (cdrutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]cdrjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []cdrjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := cdrjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]cdrjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := cdrjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]cdrjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := cdrjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]cdrjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]cdrjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []cdrjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := cdrjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]cdrjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := cdrjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]cdrjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := cdrjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]cdrjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := cdrjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := cdrjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address cdrutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address cdrutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address cdrutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address cdrutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*cdrutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return cdrutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address cdrutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := cdrjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address cdrutil.Address) (*cdrutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := cdrjson.NewImportAddressCmd(address, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, rescan bool) FutureImportAddressResult {
	cmd := cdrjson.NewImportAddressCmd(address, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *cdrutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := cdrjson.NewImportPrivKeyCmd(wif, nil, nil, nil)
	return c.sendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *cdrutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *cdrutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := cdrjson.NewImportPrivKeyCmd(wif, &label, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *cdrutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *cdrutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := cdrjson.NewImportPrivKeyCmd(wif, &label, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *cdrutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *cdrutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := cdrjson.NewImportPrivKeyCmd(wif, &label, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *cdrutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := cdrjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := cdrjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptAsync(script []byte) FutureImportScriptResult {
	...
	cmd := cdrjson.NewImportScriptCmd(scriptStr, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanAsync(script []byte, rescan bool) FutureImportScriptResult {
	...
	cmd := cdrjson.NewImportScriptCmd(scriptStr, &rescan, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportScriptRescanFromAsync(script []byte, rescan bool, scanFrom int) FutureImportScriptResult {
	...
	cmd := cdrjson.NewImportScriptCmd(scriptStr, &rescan, &scanFrom)
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountAddressIndexAsync(account string, branch uint32) FutureAccountAddressIndexResult {
	cmd := cdrjson.NewAccountAddressIndexCmd(account, int(branch))
	return c.sendCmd(cmd)
}
...
func (c *Client) AccountSyncAddressIndexAsync(account string, branch uint32, index int) FutureAccountSyncAddressIndexResult {
	cmd := cdrjson.NewAccountSyncAddressIndexCmd(account, int(branch), index)
	return c.sendCmd(cmd)
}
...
func (c *Client) RevokeTicketsAsync() FutureRevokeTicketsResult {
	cmd := cdrjson.NewRevokeTicketsCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicketAsync(rawHex string) FutureAddTicketResult {
	cmd := cdrjson.NewAddTicketCmd(rawHex)
	return c.sendCmd(cmd)
}
...
func (c *Client) AddTicket(ticket *cdrutil.Tx) error {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGenerateVoteResult) Receive() (*cdrjson.GenerateVoteResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes cdrjson.GenerateVoteResult
...
func (c *Client) GenerateVoteAsync(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) FutureGenerateVoteResult {
	cmd := cdrjson.NewGenerateVoteCmd(blockHash.String(), height, sstxHash.String(), voteBits, voteBitsExt)
	return c.sendCmd(cmd)
}

// GenerateVote returns hex of an SSGen.
func (c *Client) GenerateVote(blockHash *chainhash.Hash, height int64, sstxHash *chainhash.Hash, voteBits uint16, voteBitsExt string) (*cdrjson.GenerateVoteResult, error) {
	return c.GenerateVoteAsync(blockHash, height, sstxHash, voteBits, voteBitsExt).Receive()
}

// NOTE: While getinfo is implemented here (in wallet.go), a cdrd chain server
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureGetInfoResult) Receive() (*cdrjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes cdrjson.InfoWalletResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetInfo() (*cdrjson.InfoWalletResult, error) {
...
func (r FutureGetStakeInfoResult) Receive() (*cdrjson.GetStakeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes cdrjson.GetStakeInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeInfoAsync() FutureGetStakeInfoResult {
	cmd := cdrjson.NewGetStakeInfoCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetStakeInfo() (*cdrjson.GetStakeInfoResult, error) {
...
func (r FutureGetTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	var tixRes cdrjson.GetTicketsResult
...
func (c *Client) GetTicketsAsync(includeImmature bool) FutureGetTicketsResult {
	cmd := cdrjson.NewGetTicketsCmd(includeImmature)
	return c.sendCmd(cmd)
}
...
func (r FutureListScriptsResult) Receive() ([][]byte, error) {
	...
	var resScr cdrjson.ListScriptsResult
...
func (c *Client) SetTicketFeeAsync(fee cdrutil.Amount) FutureSetTicketFeeResult {
	cmd := cdrjson.NewSetTicketFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTicketFee sets the ticket fee per KB amount.
func (c *Client) SetTicketFee(fee cdrutil.Amount) error {
...
func (c *Client) SetTxFeeAsync(fee cdrutil.Amount) FutureSetTxFeeResult {
	cmd := cdrjson.NewSetTxFeeCmd(fee.ToCoin())
	return c.sendCmd(cmd)
}

// SetTxFee sets the transaction fee per KB amount.
func (c *Client) SetTxFee(fee cdrutil.Amount) error {
...
// Receive waits for the response promised by the future.
func (r FutureGetVoteChoicesResult) Receive() (*cdrjson.GetVoteChoicesResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var choicesRes cdrjson.GetVoteChoicesResult
...
func (c *Client) SetVoteChoiceAsync(agendaID, choiceID string) FutureSetVoteChoiceResult {
	cmd := cdrjson.NewSetVoteChoiceCmd(agendaID, choiceID)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureStakePoolUserInfoResult) Receive() (*cdrjson.StakePoolUserInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes cdrjson.StakePoolUserInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) StakePoolUserInfoAsync(addr cdrutil.Address) FutureStakePoolUserInfoResult {
	cmd := cdrjson.NewStakePoolUserInfoCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}

// StakePoolUserInfo returns a list of tickets and information about them
// that are paying to the passed address.
func (c *Client) StakePoolUserInfo(addr cdrutil.Address) (*cdrjson.StakePoolUserInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureTicketsForAddressResult) Receive() (*cdrjson.TicketsForAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes cdrjson.TicketsForAddressResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
//
// See GetInfo for the blocking version and more details.
func (c *Client) TicketsForAddressAsync(addr cdrutil.Address) FutureTicketsForAddressResult {
	cmd := cdrjson.NewTicketsForAddressCmd(addr.EncodeAddress())
	return c.sendCmd(cmd)
}
...
// owned by the wallet.
func (c *Client) TicketsForAddress(addr cdrutil.Address) (*cdrjson.TicketsForAddressResult, error) {
...
// Receive waits for the response promised by the future and returns the stake
// info provided by the server.
func (r FutureWalletInfoResult) Receive() (*cdrjson.WalletInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes cdrjson.WalletInfoResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletInfoAsync() FutureWalletInfoResult {
	cmd := cdrjson.NewWalletInfoCmd()
	return c.sendCmd(cmd)
}

// WalletInfo returns wallet global state info for a given wallet.
func (c *Client) WalletInfo() (*cdrjson.WalletInfoResult, error) {
	return c.WalletInfoAsync().Receive()
}

// TODO(davec): Implement
// backupwallet (NYI in cdrwallet)
// encryptwallet (Won't be supported by cdrwallet since it's always encrypted)
// getwalletinfo (NYI in cdrwallet or cdrjson)
// listaddressgroupings (NYI in cdrwallet)
// listreceivedbyaccount (NYI in cdrwallet)

// DUMP
// importwallet (NYI in cdrwallet)
// dumpwallet (NYI in cdrwallet)
