...
//
// NOTE: This is a cdrd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := cdrjson.NewDebugLevelCmd(levelSpec)
	return c.sendCmd(cmd)
}
...
func (r FutureEstimateStakeDiffResult) Receive() (*cdrjson.EstimateStakeDiffResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var est cdrjson.EstimateStakeDiffResult
...
func (c *Client) EstimateStakeDiffAsync(tickets *uint32) FutureEstimateStakeDiffResult {
	cmd := cdrjson.NewEstimateStakeDiffCmd(tickets)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) EstimateStakeDiff(tickets *uint32) (*cdrjson.EstimateStakeDiffResult, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address cdrutil.Address) FutureExistsAddressResult {
	cmd := cdrjson.NewExistsAddressCmd(address.EncodeAddress())
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) ExistsAddress(address cdrutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []cdrutil.Address) FutureExistsAddressesResult {
	addrsStr := make([]string, len(addresses))
	for i := range addresses {
		addrsStr[i] = addresses[i].EncodeAddress()
	}

	cmd := cdrjson.NewExistsAddressesCmd(addrsStr)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) ExistsAddresses(addresses []cdrutil.Address) (string, error) {
...
func (c *Client) ExistsMissedTicketsAsync(hashes []*chainhash.Hash) FutureExistsMissedTicketsResult {
	...
	cmd := cdrjson.NewExistsMissedTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsExpiredTicketsAsync(hashes []*chainhash.Hash) FutureExistsExpiredTicketsResult {
	...
	cmd := cdrjson.NewExistsExpiredTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketAsync(hash *chainhash.Hash) FutureExistsLiveTicketResult {
	cmd := cdrjson.NewExistsLiveTicketCmd(hash.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketsAsync(hashes []*chainhash.Hash) FutureExistsLiveTicketsResult {
	...
	cmd := cdrjson.NewExistsLiveTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsMempoolTxsAsync(hashes []*chainhash.Hash) FutureExistsMempoolTxsResult {
	...
	cmd := cdrjson.NewExistsMempoolTxsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := cdrjson.NewExportWatchingWalletCmd(&account, cdrjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by cdrwallet to enable a wallet which does not have the private keys
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int64, error) {
	...
	var bestBlock cdrjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := cdrjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := cdrjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// getheaders result.
func (r FutureGetHeadersResult) Receive() (*cdrjson.GetHeadersResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr cdrjson.GetHeadersResult
...
func (c *Client) GetHeadersAsync(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := cdrjson.NewGetHeadersCmd(hex.EncodeToString(concatenatedLocators),
		hashStop.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeaders(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) (*cdrjson.GetHeadersResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeDifficultyResult) Receive() (*cdrjson.GetStakeDifficultyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cdrjson.GetStakeDifficultyResult.
	var gsdr cdrjson.GetStakeDifficultyResult
...
func (c *Client) GetStakeDifficultyAsync() FutureGetStakeDifficultyResult {
	cmd := cdrjson.NewGetStakeDifficultyCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) GetStakeDifficulty() (*cdrjson.GetStakeDifficultyResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionsResult) Receive() (*cdrjson.GetStakeVersionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cdrjson.GetStakeVersionsResult.
	var gsvr cdrjson.GetStakeVersionsResult
...
func (c *Client) GetStakeVersionInfoAsync(count int32) FutureGetStakeVersionInfoResult {
	cmd := cdrjson.NewGetStakeVersionInfoCmd(count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) GetStakeVersionInfo(count int32) (*cdrjson.GetStakeVersionInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionInfoResult) Receive() (*cdrjson.GetStakeVersionInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cdrjson.GetStakeVersionInfoResult.
	var gsvr cdrjson.GetStakeVersionInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeVersionsAsync(hash string, count int32) FutureGetStakeVersionsResult {
	cmd := cdrjson.NewGetStakeVersionsCmd(hash, count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) GetStakeVersions(hash string, count int32) (*cdrjson.GetStakeVersionsResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetTicketPoolValueAsync() FutureGetTicketPoolValueResult {
	cmd := cdrjson.NewGetTicketPoolValueCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) GetTicketPoolValue() (cdrutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetVoteInfoResult) Receive() (*cdrjson.GetVoteInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a cdrjson.GetVoteInfoResult.
	var gsvr cdrjson.GetVoteInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVoteInfoAsync(version uint32) FutureGetVoteInfoResult {
	cmd := cdrjson.NewGetVoteInfoCmd(version)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) GetVoteInfo(version uint32) (*cdrjson.GetVoteInfoResult, error) {
...
func (r FutureListAddressTransactionsResult) Receive() ([]cdrjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a cdrd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []cdrutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := cdrjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a cdrwallet extension.
func (c *Client) ListAddressTransactions(addresses []cdrutil.Address, account string) ([]cdrjson.ListTransactionsResult, error) {
...
func (r FutureLiveTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a cdrjson.LiveTicketsResult.
	var container cdrjson.LiveTicketsResult
...
func (r FutureMissedTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a cdrjson.MissedTicketsResult.
	var container cdrjson.MissedTicketsResult
	err = json.Unmarshal(res, &container)
	if err != nil {
		return nil, err
	}
...
func (c *Client) MissedTicketsAsync() FutureMissedTicketsResult {
	cmd := cdrjson.NewMissedTicketsCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*cdrjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session cdrjson.SessionResult
...
//
// NOTE: This is a commanderu extension.
...
//
// NOTE: This is a commanderu extension.
func (c *Client) Session() (*cdrjson.SessionResult, error) {
...
func (r FutureTicketFeeInfoResult) Receive() (*cdrjson.TicketFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir cdrjson.TicketFeeInfoResult
...
func (c *Client) TicketFeeInfoAsync(blocks *uint32, windows *uint32) FutureTicketFeeInfoResult {
	...
	cmd := cdrjson.NewTicketFeeInfoCmd(blocks, windows)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a commanderu extension.
func (c *Client) TicketFeeInfo(blocks *uint32, windows *uint32) (*cdrjson.TicketFeeInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (cdrutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amt, err := cdrutil.NewAmount(vwap)
	if err != nil {
		return 0, err
	}
...
func (c *Client) TicketVWAPAsync(start *uint32, end *uint32) FutureTicketVWAPResult {
	...
	cmd := cdrjson.NewTicketVWAPCmd(start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a commanderu extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (cdrutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the
// txfeeinfo result.
func (r FutureTxFeeInfoResult) Receive() (*cdrjson.TxFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir cdrjson.TxFeeInfoResult
	err = json.Unmarshal(res, &tfir)
	if err != nil {
		return nil, err
	}
...
func (c *Client) TxFeeInfoAsync(blocks *uint32, start *uint32, end *uint32) FutureTxFeeInfoResult {
	...
	cmd := cdrjson.NewTxFeeInfoCmd(blocks, start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a commanderu extension.
func (c *Client) TxFeeInfo(blocks *uint32, start *uint32, end *uint32) (*cdrjson.TxFeeInfoResult, error) {
...
// result.
func (r FutureVersionResult) Receive() (map[string]cdrjson.VersionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr map[string]cdrjson.VersionResult
	err = json.Unmarshal(res, &vr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) VersionAsync() FutureVersionResult {
	cmd := cdrjson.NewVersionCmd()
	return c.sendCmd(cmd)
}

// Version returns information about the server's JSON-RPC API versions.
func (c *Client) Version() (map[string]cdrjson.VersionResult, error) {
