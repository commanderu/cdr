...
In order maintain the peer-to-peer commanderu network, there needs to be a source
of addresses to connect to as nodes come and go.  The commanderu protocol provides
