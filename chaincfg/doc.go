...
//
// In addition to the main commanderu network, which is intended for the transfer
...
// wire.commanderuNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := cdrutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard commanderu networks,
