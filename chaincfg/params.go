...
var (
	...
	// mainPowLimit is the highest proof of work value a commanderu block can
	// have for the main network.  It is the value 2^224 - 1.
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 224), bigOne)

	// testNetPowLimit is the highest proof of work value a commanderu block
	// can have for the test network.  It is the value 2^232 - 1.
	testNetPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 232), bigOne)

	// simNetPowLimit is the highest proof of work value a commanderu block
...
// Params defines a commanderu network by its parameters.  These parameters may be
// used by commanderu applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Ticket pool sizes for commanderu PoS. This denotes the number of possible
	...
	// Average number of tickets per block for commanderu PoS.
...
// MainNetParams defines the network parameters for the main commanderu network.
var MainNetParams = Params{
	Name:        "mainnet",
	Net:         wire.MainNet,
	DefaultPort: "9108",
	DNSSeeds: []DNSSeed{
		{"mainnet-seed.commanderu.mincdry.org", true},
		{"mainnet-seed.commanderu.netpurgatory.com", true},
		{"mainnet-seed.commanderu.org", true},
	},
	...
	// commanderu organization related parameters
...
var TestNet2Params = Params{
	...
	DefaultPort: "19108",
	DNSSeeds: []DNSSeed{
		{"testnet-seed.commanderu.mincdry.org", true},
		{"testnet-seed.commanderu.netpurgatory.com", true},
		{"testnet-seed.commanderu.org", true},
	},
...
// SimNetParams defines the network parameters for the simulation test commanderu
...
var (
	// ErrDuplicateNet describes an error where the parameters for a commanderu
	// network could not be set due to the network already being a standard
	// network or previously-registered into this package.
	ErrDuplicateNet = errors.New("duplicate commanderu network")
...
// Register registers the network parameters for a commanderu network.  This may
