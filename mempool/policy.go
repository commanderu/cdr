...
// Copyright (c) 2017-2018 The commanderu developers
...
const (
	...
	DefaultMinRelayTxFee = cdrutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee cdrutil.Amount) int64 {
	...
	if minFee < 0 || minFee > cdrutil.MaxAmount {
		minFee = cdrutil.MaxAmount
	}
...
func checkInputsStandard(tx *cdrutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee cdrutil.Amount) bool {
...
func checkTransactionStandard(tx *cdrutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee cdrutil.Amount,
