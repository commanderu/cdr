...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/commanderu/cdrd/mempool)

Package mempool provides a policy-enforced pool of unmined commanderu transactions.

A key responsibility of the commanderu network is mining transactions – regular
...
Since this package does not deal with other commanderu specifics such as network
...
package for any projects needing the ability create an in-memory pool of commanderu
...
```bash
$ go get -u github.com/commanderu/cdrd/mempool
```
