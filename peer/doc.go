...
/*
Package peer provides a common base for creating and managing commanderu network
peers.

Overview

This package builds upon the wire package, which provides the fundamental
primitives necessary to speak the commanderu wire protocol, in order to simplify
...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe commanderu peer for handling commanderu
   communications via the peer-to-peer protocol
 - Full duplex reading and writing of commanderu protocol messages
 ...
 - Flexible peer configuration
   ...
   - Ability to register callbacks for handling commanderu protocol messages
...
caller to specify things such as the user agent name and version, the commanderu
network to use, which services it supports, and callbacks to invoke when commanderu
...
In order to do anything useful with a peer, it is necessary to react to commanderu
...
For convenience, a callback hook for all of the currently supported commanderu
...
(https://godoc.org/github.com/commanderu/cdrd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
