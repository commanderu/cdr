...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/commanderu/cdrd/peer)
...
```bash
$ go get -u github.com/commanderu/cdrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/commanderu/cdrd/peer#example-package--NewOutboundPeer)  
