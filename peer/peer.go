...
// Peer provides a basic concurrent safe commanderu peer for handling commanderu
...
// callbacks for handling commanderu protocol messages.
//
...
// newPeerBase returns a new base commanderu peer based on the inbound flag.  This
...
// NewInboundPeer returns a new inbound commanderu peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound commanderu peer.
