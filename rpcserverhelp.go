...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, cdrD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in cdr as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in cdr as the value",
	...
	"scriptpubkeyresult-addresses": "The commanderu addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in cdr",
	...
	"decodescriptresult-addresses": "The commanderu addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (cdrd extension)",
	...
	"getcurrentnet--synopsis": "Get commanderu network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in cdr/KB",
	...
	"infowalletresult-balance":         "The total commanderu balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in cdr/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in commanderu",
	...
	"gettxoutresult-value":         "The transaction amount in cdr",
	...
	"searchrawtransactions-address":     "The commanderu address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (cdrd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown cdrd.",
	"stop--result0":  "The string 'cdrd stopping.'",
	...
	"validateaddresschainresult-address": "The commanderu address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "commanderu address to validate",
	...
	"verifymessage-address":   "The commanderu address to use for the signature",
	...
	// -------- commanderu-specific help --------

	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in cdr/kb.",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: cdr/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: cdr/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: cdr/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: cdr/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*cdrjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*cdrjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatestakediff":     {(*cdrjson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]cdrjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*cdrjson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*cdrjson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*cdrjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*cdrjson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*cdrjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getcfilter":            {(*string)(nil)},
	"getcfilterheader":      {(*string)(nil)},
	"getchaintips":          {(*[]cdrjson.GetChainTipsResult)(nil)},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*cdrjson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*cdrjson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*cdrjson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*cdrjson.GetHeadersResult)(nil)},
	"getinfo":               {(*cdrjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*cdrjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*cdrjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*cdrjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]cdrjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*cdrjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*cdrjson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*cdrjson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*cdrjson.GetVoteInfoResult)(nil)},
	"getwork":               {(*cdrjson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*cdrjson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*cdrjson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]cdrjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*cdrjson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*cdrjson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*cdrjson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*cdrjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]cdrjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*cdrjson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := cdrjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := cdrjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
