...
var (
	...
	defaultDataDir  = filepath.Join(cdrdHomeDir, "data")
...
type config struct {
	DataDir       string `short:"b" long:"datadir" description:"Location of the cdrd data directory"`
	DbType        string `long:"dbtype" description:"Database backend to use for the Block Chain"`
	TestNet       bool   `long:"testnet" description:"Use the test network"`
	SimNet        bool   `long:"simnet" description:"Use the simulation test network"`
	NumCandidates int    `short:"n" long:"numcandidates" description:"Max num of checkpoint candidates to show {1-20}"`
	UseGoOutput   bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the cdrchain checkpoint list"`
}
...
// netName returns the name used when referring to a commanderu network.  At the
// time of writing, cdrd currently places blocks for testnet version 2 in the
