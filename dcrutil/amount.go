...
// units, "1eN cdr" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " cdr"
	}
}
...
//
// NewAmount is for specifically for converting cdr to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/commanderu/cdrd/cdrutil#example-Amount
...
// useful for services that build on top of commanderu (for example, calculating
