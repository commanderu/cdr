...
commanderu transaction scripts.

Script Overview

commanderu transaction scripts are written in a stack-base, FORTH-like language.

The commanderu script language consists of a number of opcodes which fall into
...
The vast majority of commanderu scripts at the time of this writing are of several
...
what conditions must be met in order to spend commanderus.
