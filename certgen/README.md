...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/commanderu/cdrd/certgen)
...
```bash
$ go get -u github.com/commanderu/cdrd/certgen
```
