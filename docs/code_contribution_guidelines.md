...
reason, the cdrd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire cdrd
...
One of the major design goals of all core cdrd packages is to aim for complete
...
- If a commit modifies a component in any of the packages besides the main
  package use the package name as the commit prefix (eg. `cdrjson`).
...
contributions.  This is how to get your changes into cdrd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/commanderu/cdrd/graphs/contributors)!
...
[ISC license](https://github.com/commanderu/cdrd/blob/master/LICENSE).  This is
the same license as all of the code in the cdrd suite.
