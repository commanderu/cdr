cdrd allows you to bind the RPC server to specific interfaces which enables you
...
|--rpclisten=:37460|all interfaces on port 37460|
|--rpclisten=0.0.0.0:37460|all IPv4 interfaces on port 37460|
|--rpclisten=[::]:37460|all IPv6 interfaces on port 37460|
|--rpclisten=127.0.0.1:37460|only IPv4 localhost on port 37460|
|--rpclisten=[::1]:37460|only IPv6 localhost on port 37460|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:37460|IPv4 localhost on port 8337 and IPv6 localhost on port 37460|
|--rpclisten=:37460 --listen=:8337|all interfaces on ports 37460 and 8337|

The following config file would configure the cdrd RPC server to listen to all interfaces on the default port, including external interfaces, for both IPv4 and IPv6:
