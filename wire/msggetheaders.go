...
// MsgGetHeaders implements the Message interface and represents a commanderu
...
// NewMsgGetHeaders returns a new commanderu getheaders message that conforms to
