...
// BlockHeader defines information about a block and is used in the commanderu
...
// readBlockHeader reads a commanderu block header from r.  See Deserialize for
...
// writeBlockHeader writes a commanderu block header to w.  See Serialize for
