...
// MsgInv implements the Message interface and represents a commanderu inv message.
...
// NewMsgInv returns a new commanderu inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new commanderu inv message that conforms to the
