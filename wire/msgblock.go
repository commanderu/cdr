...
// MsgBlock implements the Message interface and represents a commanderu
...
// BtcDecode decodes from the commanderu wire protocol as it was sent across the
...
// the commanderu wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new commanderu block message that conforms to the
