...
// maxNetAddressPayload returns the max payload size for a commanderu NetAddress
...
type NetAddress struct {
	...
	// not present in the commanderu version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The commanderu protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  commanderu protocol mixes little and big endian.
