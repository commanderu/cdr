...
// MsgNotFound defines a commanderu notfound message which is sent in response to
...
// NewMsgNotFound returns a new commanderu notfound message that conforms to the
