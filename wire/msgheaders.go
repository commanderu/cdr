...
// a single commanderu headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a commanderu headers
...
// NewMsgHeaders returns a new commanderu headers message that conforms to the
