...
// MsgGetData implements the Message interface and represents a commanderu
...
// NewMsgGetData returns a new commanderu getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new commanderu getdata message that conforms to
