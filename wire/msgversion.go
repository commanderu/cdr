...
const DefaultUserAgent = "/cdrwire:0.3.0/"

// MsgVersion implements the Message interface and represents a commanderu version
...
// NewMsgVersion returns a new commanderu version message that conforms to the
...
// and local address from conn and returns a new commanderu version message that
