...
// MsgReject implements the Message interface and represents a commanderu reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the commanderu protocol does not enforce a sane
...
// NewMsgReject returns a new commanderu reject message that conforms to the
