...
// ServiceFlag identifies services supported by a commanderu peer.
...
// CurrencyNet represents which commanderu network a message belongs to.
type CurrencyNet uint32

// Constants used to indicate the message commanderu network.  They can also be
// used to seek to the next message when a stream's state is unknown, but
// this package does not provide that functionality since it's generally a
// better idea to simply disconnect clients that are misbehaving over TCP.
const (
	// MainNet represents the main commanderu network.
...
// bnStrings is a map of commanderu networks back to their constant names for
// pretty printing.
