...
// MsgPing implements the Message interface and represents a commanderu ping
// message.
//
...
// NewMsgPing returns a new commanderu ping message that conforms to the Message
