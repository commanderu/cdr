...
// MsgGetBlocks implements the Message interface and represents a commanderu
...
// NewMsgGetBlocks returns a new commanderu getblocks message that conforms to the
