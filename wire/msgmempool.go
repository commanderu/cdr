...
// MsgMemPool implements the Message interface and represents a commanderu mempool
...
// NewMsgMemPool returns a new commanderu pong message that conforms to the Message
