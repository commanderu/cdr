...
The default options are sane for most users.  This means cdrd will work 'out of
...
parsed when cdrd starts up.  By default, the configuration file is located at
~/.cdrd/cdrd.conf on POSIX-style operating systems and %LOCALAPPDATA%\cdrd\cdrd.conf
